...
static u32 ar7100_ahb_freq=0, ar7100_cpu_freq, ar7100_ddr_freq;
...
hal_platform_init(void)
{
    ...
    switch (ar7100_reg_rd(AR7100_REV_ID) & AR7100_REV_ID_MASK)
    {
	case AR7100_REV_ID_AR7130: rev=30; break;
	case AR7100_REV_ID_AR7141: rev=41; break;
	case AR7100_REV_ID_AR7161: rev=61; break;
	default: rev=0; break;
    }

    diag_printf ("\nAR71%2d CPU %dMHz, DDR %dMHz, AHB %dMHz\n", rev,
		 ar7100_cpu_freq/1000000,
		 ar7100_ddr_freq/1000000,
		 ar7100_ahb_freq/1000000);
}
...
{
    u32 pll, pll_div, cpu_div, ddr_div, ahb_div, freq;
