...
function Butterlation() {
  ...
  this.initializeDictionary = function() {
    ...
    if(request.status==200) { 
      ...
      {
      	try { xmlDom = new ActiveXObject("MSXML2.DOMDocument"); } 
      	catch(e5) 
      	{
            try { xmlDom = document.implementation.createDocument("","",null);}  
      		catch(e6) 
      		{ return; }
      	}
      };
      ...
      var pos = xmlDom.documentElement.getElementsByTagName("message");
