...
typedef struct {
    ...
    struct work_struct      mac_check_link;
 ...
 * at compile time.
 */
#define AG7100_MAC_CFG0_GMII  0
#define AG7100_MAC_CFG0_MII   1
#define AG7100_MAC_CFG0_RGMII 2
#define AG7100_MAC_CFG0_RMII  3

#if defined (CONFIG_AG7100_GE0_GMII) || defined (CONFIG_ATHRS_PHY)
    #define     AG7100_MII0_INTERFACE   AG7100_MAC_CFG0_GMII
#elif defined (CONFIG_AG7100_GE0_MII)
    #define     AG7100_MII0_INTERFACE   AG7100_MAC_CFG0_MII
#elif defined (CONFIG_AG7100_GE0_RGMII)
    #define     AG7100_MII0_INTERFACE   AG7100_MAC_CFG0_RGMII
#elif defined (CONFIG_AG7100_GE0_RMII)
    #define     AG7100_MII0_INTERFACE   AG7100_MAC_CFG0_RMII
 ...
 */
    ...
    #define AG7100_MAC_CFG1_RGMII 0
    #define AG7100_MAC_CFG1_RMII  1

    #if defined (CONFIG_AG7100_GE1_RGMII) || defined (CONFIG_ATHRS_PHY)
        #define AG7100_MII1_INTERFACE   AG7100_MAC_CFG1_RGMII
    #elif defined (CONFIG_AG7100_GE1_RMII)
        #define AG7100_MII1_INTERFACE   AG7100_MAC_CFG1_RMII
...
int ag7100_hard_start(struct sk_buff *skb, struct net_device *dev);
