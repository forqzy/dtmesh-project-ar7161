...
void
ath_initialize_force_ppm_module (ath_force_ppm_t     *afp, 
                                 struct ath_softc    *sc, 
                                 osdev_t             sc_osdev,
                                 struct ath_hal      *ah,
...
void
ath_start_force_ppm_module (ath_force_ppm_t *afp)
{
...
void
ath_halt_force_ppm_module (ath_force_ppm_t *afp)
{
