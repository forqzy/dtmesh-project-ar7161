...
void athrs26_reg_init()
{
    ...
    athrs26_reg_write(0x8, 0x012e1bea);
    athrs26_reg_write(0x100, 0x7e);
#endif
...
#endif
#ifdef CONFIG_ATHRS16_PHY
    //disable port 5, use 0x200 if port 5 is enabled
    athrs26_reg_write(0x600, 0x7e);

    athrs26_reg_write(0x2c, 0x003f003f);
