...
#define CYGINT_ISO_CTYPE 0
#define CYGINT_ISO_CTYPE_0
...
#define CYGINT_ISO_LOCALE 0
#define CYGINT_ISO_LOCALE_0
#define CYGINT_ISO_STDLIB_STRCONV 0
#define CYGINT_ISO_STDLIB_STRCONV_0
#define CYGINT_ISO_STDLIB_STRCONV_FLOAT 0
#define CYGINT_ISO_STDLIB_STRCONV_FLOAT_0
#define CYGINT_ISO_RAND 0
#define CYGINT_ISO_RAND_0
...
#define CYGINT_ISO_STDLIB_ENVIRON 0
#define CYGINT_ISO_STDLIB_ENVIRON_0
#define CYGINT_ISO_STDLIB_SYSTEM 0
#define CYGINT_ISO_STDLIB_SYSTEM_0
#define CYGINT_ISO_BSEARCH 0
#define CYGINT_ISO_BSEARCH_0
#define CYGINT_ISO_QSORT 0
#define CYGINT_ISO_QSORT_0
#define CYGINT_ISO_ABS 0
#define CYGINT_ISO_ABS_0
#define CYGINT_ISO_DIV 0
#define CYGINT_ISO_DIV_0
#define CYGINT_ISO_STDLIB_MULTIBYTE 0
#define CYGINT_ISO_STDLIB_MULTIBYTE_0
