...
#define CYGSEM_HAL_DIAG_MANGLER GDB
#define CYGSEM_HAL_DIAG_MANGLER_GDB
...
#define CYGDBG_HAL_DEBUG_GDB_INCLUDE_STUBS 1
#define CYGDBG_HAL_DEBUG_GDB_BREAK_SUPPORT 1
